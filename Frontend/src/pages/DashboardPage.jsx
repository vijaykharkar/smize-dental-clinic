...
const recentActivity = [
  { icon: 'medical_information', text: 'X-Ray results uploaded', date: 'May 1, 2026', color: 'text-[#707881]' },
  { icon: 'receipt_long', text: 'Invoice #4821 paid – $180', date: 'May 5, 2026', color: 'text-[#707881]' },
  { icon: 'calendar_today', text: 'Follow-up appointment scheduled', date: 'May 8, 2026', color: 'text-[#005d90]' },
  { icon: 'check_circle', text: 'Dental cleaning completed', date: 'May 10, 2026', color: 'text-[#006b5b]' },
]
        ...
        <div className="pt-20 flex">
          ...
          <aside className="hidden lg:flex flex-col w-64 bg-white border-r border-sky-50 min-h-screen pt-8 px-6 space-y-1 fixed top-20 left-0 bottom-0 overflow-y-auto">
            ...
            {[
              ...
              <button
                key={item.label}
                className={`flex items-center gap-3 px-4 py-3 rounded-xl font-medium text-sm transition-all ${item.active
