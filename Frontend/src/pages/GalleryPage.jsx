...
const galleryImages = [
  /* ── Our Team ── */
  {
    ...
    subtitle: 'BDS, MDS – Oral & Maxillofacial Surgeon',
  ...
  /* ── Cosmetic & Others (existing stock) ── */
  {
  ...
  },
  {
    ...
    tag: 'Cosmetic Dentistry', title: 'Bridge Restoration', span: 'md:col-span-1 md:row-span-1',
  },
  {
    ...
    tag: 'Cosmetic Dentistry', title: 'Teeth Whitening Results', span: 'md:col-span-1 md:row-span-1',
  },
  {
          ...
          <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="flex flex-wrap justify-center gap-3">
            {categories.map((cat) => (
              <motion.button
                ...
                className={`px-5 py-2 rounded-full font-medium transition-all text-sm sm:text-base ${
                  activeFilter === cat
        ...
        {(activeFilter === 'All Photos' || activeFilter === 'Our Team') && (
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {[
                { src: drShubham,  name: 'Dr. Shubham Kharat', qual: 'BDS, MDS', spec: 'Oral & Maxillofacial Surgeon', exp: '10+ Years Experience' },
                { src: drDipika,   name: 'Dr. Deepika Waghmare Kharat', qual: 'BDS, MDS', spec: 'Cosmetic & Restorative Dentist', exp: '8+ Years Experience' },
              ].map((doc, i) => (
                <motion.div
                  key={doc.name}
            ...
            <AnimatePresence mode="popLayout">
              {filtered
                ...
                <motion.div
                  ...
                  className={`relative group overflow-hidden rounded-xl air-shadow bg-white cursor-pointer ${
